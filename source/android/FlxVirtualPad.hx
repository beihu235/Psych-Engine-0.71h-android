...
class FlxVirtualPad extends FlxSpriteGroup {
	...
	public function new(?DPad:FlxDPadMode, ?Action:FlxActionMode, ?alphaAlt:Float = 0.75, ?antialiasingAlt:Bool = true) {
		...
		switch (Action){
			...
			case MenuCharacterEditor:
				actions.add(add(buttonA = createButton(FlxG.width - 44 * 3 - 335, FlxG.height - 45 * 3, 44 * 3, 127, "a", 0xFF0000)));
				actions.add(add(buttonB = createButton(FlxG.width - 44 * 3 - 335, FlxG.height - 85 * 3, 44 * 3, 127, "b", 0xFFCB00)));	
			case NOTESTATE:
